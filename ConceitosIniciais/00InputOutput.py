# o comando print escreve coisas na tela, por convenção o texto dentro do print fica entre aspas simples
# entretanto também funciona com aspas duplas
print('hello World')
print("ola Mundo")

# O comando print, salta uma linha ao sem fim automaticamente, entretando podemos definir um "comando" alternativo para
...
# que não precisa necessáriamente receber um tipo. o comando input() pode receber uma string, essa será mostrada ao usuário
