...
for c in range(0, 5):
    ...
    print(f'apenas 1 valor fornecido, seu valor é: {soma}' if (c + 1) == 1 else f'{c + 1} valores fornecidos, a soma deles ' f'é igual a {soma}')

palavra = 'bola'
print("letras da palavra")
for posicao, letra in enumerate(
        palavra):  # o for de uma string retorna cada caractere da mesma, o enumerate torna possivel vc saber
